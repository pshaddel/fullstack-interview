...
export const STANDARD_ERRORS = {
	...
	BILLING_PERIODS_MORE_THAN_12_MONTHS: { status: 400, message: "billingPeriodsMoreThan12Months" },
	BILLING_PERIODS_LESS_THAN_6_MONTHS: { status: 400, message: "billingPeriodsLessThan6Months" },
	BILLING_PERIODS_MORE_THAN_10_YEARS: { status: 400, message: "billingPeriodsMoreThan10Years" },
	BILLING_PERIODS_LESS_THAN_3_YEARS: { status: 400, message: "billingPeriodsLessThan3Years" },
